...
DIC_FILE_ENTRY* dic_file[MAX_DIC_NUMBER]; /* 木のもとデータ(辞書ファイル) */
...
main(int argc, char *argv[])
{
  ...
  printf("File Name \"%s\"\n",inkey);
  dic_file[number_of_tree] = my_open_entry(inkey);
...
*   string --- 文字列
****************************************************/
void insert_dic_data(DIC_FILE_ENTRY *f, pat_node *x_ptr, char *kugiri)
{
